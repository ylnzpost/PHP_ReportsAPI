<?php
	...
	if (strtoupper($api_code) === strtoupper("weeklyReports"))
	{
		...
		//sort array in DESC order (shift the latest LOG information to the font)
		rsort($auditLogsArr);
	...
	function getMonthlyReportFiles($objArr)
	{
		...
		$monthlyReportObjArr = array_reverse($monthlyReportObjArr);
		//print_r($monthlyReportObjArr);
	...
	{
		//return array in the reverse order
		$audit_logs_arr = array_reverse($audit_logs_arr);
